...
env.backend.loadAcquisition('directedevolution')
env.backend.acquisition.settings.name='directedevolution'
...
#env.backend.saveAcquisition('my-visitmarkedcells.acq')
#env.backend.stageAcquisition('my-visitmarkedcells.acq')
#env.acquisitionLoop(maxIter=1)