...
env.backend.setUser('mpmay','')
env.loadConfiguration()
env.backend.clearCache()
env.backend.clearAllStagedAcquisitions()
env.backend.getXStageBounds([])
env.backend.getYStageBounds([])
env.backend.getXStageBounds([])
env.backend.setXStageBounds([])
env.backend.setYStageBounds([])
env.backend.setXStageBounds([])
env.acquisitionLoopWithBreak()
